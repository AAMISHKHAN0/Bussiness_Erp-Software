...
export const INITIAL_SEED_DATA = {
  ...
  roles: [
    ...
    { id: "r-2", name: "Administrator", description: "Full administrative governance, user security, and enterprise config" },
    { id: "r-3", name: "Manager", description: "Store, inventory, sales, and operational oversight" },
    { id: "r-4", name: "Accountant", description: "General ledger, journal vouchers, reconciliation & statements" },
    { id: "r-5", name: "Cashier", description: "Fast Point of Sale billing, register sessions, and receipts" },
    { id: "r-6", name: "Executive Admin", description: "Executive departmental oversight and reporting" },
    { id: "r-7", name: "Financial Controller", description: "Executive financial controller and audit reporting" },
    { id: "r-8", name: "Inventory Specialist", description: "Stock transfers, warehouse adjustments, and catalog management" },
    { id: "r-9", name: "HR Director", description: "Staff directory, digital attendance, and payroll issuance" },
    { id: "r-10", name: "Senior Sales Representative", description: "Customer accounts, quotations, and sales order fulfillment" }
  ],
  ...
  customers: [
    {
      ...
      company_name: "Walk-in Retail Client",
      contact_person: "Walk-in Counter",
      email: "pos@nexiserp.com",
      phone: "+92 (21) 111-000-000",
      address: "Direct Counter POS",
      tax_number: "Unregistered",
      credit_limit: 0,
      total_spent: 345000,
      current_balance: 0,
      status: "Active"
  ...
  pos_registers: [
    {
      id: "reg-1",
      name: "Main Checkout Terminal 01",
      code: "REG-KHI-01",
      branch_id: "b-1",
      warehouse_id: "wh-1",
      status: "Open",
  ...
  pos_sessions: [
    {
      id: "sess-1",
      register_id: "reg-1",
      register_name: "Main Checkout Terminal 01",
      cashier_id: "u-3",
  ...
  pos_sales: [
    {
      ...
      sale_date: "2026-09-10T08:15:00Z",
      subtotal: 180000,
      discount_amount: 0,
      tax_amount: 32400,
      total_amount: 212400,
      tendered_amount: 215000,
      change_due: 2600,
      payment_method: "Cash",
      payment_status: "Paid",
      status: "Completed",
      items: [
        {
          product_id: "prod-2",
          name: "Cisco Catalyst 9300-48P Managed Switch",
          sku: "NET-CAT-9300",
          quantity: 1,
          unit_price: 180000,
    ...
    },
    {
      ...
      customer_id: "cust-1",
      customer_name: "Habib Bank Limited (HBL)",
      sale_date: "2026-09-10T08:45:00Z",
      subtotal: 115000,
      discount_amount: 2400,
      tax_amount: 20000,
      total_amount: 132600,
      tendered_amount: 132600,
      change_due: 0,
      payment_method: "Card",
      payment_status: "Paid",
      status: "Completed",
      items: [
        {
          product_id: "prod-4",
          name: "Fortinet FortiGate 100F Security Appliance",
          sku: "SEC-FG-100F",
          quantity: 1,
          unit_price: 115000,
          purchase_cost: 72000,
  ...
  expenses: [
    {
      ...
      account_id: "acc-6020",
      account_code: "6020",
      account_name: "Office Facilities, Rent & Utilities",
      payment_account_id: "acc-1010",
      payment_account_code: "1010",
      payment_account_name: "Operating Checking Account (Habib Bank)",
      payee_vendor: "K-Electric Corporate Billing",
      payment_method: "Bank Transfer",
      amount: 450000,
      tax_amount: 0,
      reference_number: "KE-BILL-920184",
      description: "Karachi Distribution Hub Primary Substation Electric Power Billing",
      status: "Settled",
      created_by: "Victoria Chen"
    },
    {
      ...
      account_id: "acc-6030",
      account_code: "6030",
      account_name: "Data Center Hosting & Network Bandwidth",
      payment_account_id: "acc-1010",
      payment_account_code: "1010",
      payment_account_name: "Operating Checking Account (Habib Bank)",
      payee_vendor: "PTCL Enterprise Cloud",
      payment_method: "Bank Transfer",
      amount: 320000,
      tax_amount: 0,
      reference_number: "PTCL-INV-4412",
      description: "Dedicated Tier-3 Data Center Fiber Cross-Connect & Transit",
      status: "Settled",
      created_by: "Victoria Chen"
    },
    {
      ...
      account_id: "acc-6040",
      account_code: "6040",
      account_name: "Legal, Corporate Audit & Compliance Fees",
      payment_account_id: "acc-1010",
      payment_account_code: "1010",
      payment_account_name: "Operating Checking Account (Habib Bank)",
      payee_vendor: "A.F. Ferguson & Co. (PwC)",
      payment_method: "Bank Transfer",
      amount: 180000,
      tax_amount: 0,
      reference_number: "AFF-RET-2026",
      description: "Quarterly statutory GAAP external financial review retainer",
      status: "Settled",
      created_by: "Victoria Chen"
    }
  ],
